...
def get_venue_shows(venue_id, past):
    ...
    return db.session.query(
        ...
        Artist.id,
        Artist.name,
        Artist.image_link).join(
        Artist,
        Artist.id == Show.artist_id).filter(
            *
            queries).all()
...
def show_venue(venue_id):
    ...
    return render_template(
        ...
        venue=venue_item.venue_details)
...
def show_artist(artist_id):
    ...
    return render_template(
        ...
        artist=artist_item.artist_details)
...
def edit_artist_submission(artist_id):
    ...
    try:
        ...
        edit_artists.seeking_description = request.form.get(
            'seeking_description')
...
def create_artist_submission():
    ...
    create_artist.website_link = request.form.get('website_link')
    create_artist.seeking_venue = request.form.get('seeking_venue') == 'y'
